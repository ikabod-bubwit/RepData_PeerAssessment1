...
testStuff <- function(x,y){
  bNA <- activity_data$date == x & is.na(activity_data$steps)
  if (is.na(y)){
    activity_data[bNA, 'steps'] <- 0 
    # a <- activity_data[,] 
    # a$steps <- 0
    # print(a)
    # print(x)
    ...
    # print(y)
    activity_data[bNA, 'steps'] <- y
  }
}
mapply(testStuff, 
       gStepsPerDay$date, 
       gStepsPerDay$meanStepsPerDay)
